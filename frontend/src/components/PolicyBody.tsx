      ...
      <div className="privacy-content">
        ...
        <ul>
          ...
          <li>
            ...
            time spent watching movies, search queries.
          </li>
          <li>
          ...
          <li>
            ...
            web beacons, and similar technologies to understand user behavior
        ...
        <p>
          If you connect your CineNiche account with a third-party platform
          (e.g., Google, Facebook), we may receive information from that
          platform according to their permissions.
        </p>
        ...
        <ul>
          <li>
            <strong>Account Management:</strong> Create, maintain, and secure
            your account.
          </li>
          <li>
        ...
        <p>
          ...
          countries outside your country of residence. We implement safeguards
          to ensure appropriate protection of your data across jurisdictions.
        </p>
        ...
        <p>
          ...
          after changes become effective means you agree to the new policy.
        </p>
